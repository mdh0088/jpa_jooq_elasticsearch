...
public class JFnItemName extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>dmc_report.FN_ITEM_NAME.RETURN_VALUE</code>.
     */
     ...
     */
    public JFnItemName() {
        super("FN_ITEM_NAME", JDmcReport.DMC_REPORT, SQLDataType.VARCHAR(128));
     ...
     */
    public JFnItemName setInput1(Field<String> field) {
     ...
     * {@link org.jooq.Select} statement
     */
    public JFnItemName setInput2(Field<String> field) {
